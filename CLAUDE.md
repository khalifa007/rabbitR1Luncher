...
Read `../CLAUDE.md` first for device/network/CipherOS state and `../mylauncher/CLAUDE.md` for feature-level history — this file covers only what's different in the Compose rewrite plus the OpenClaw chat integration.
